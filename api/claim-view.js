...
<body>
  <div class="card">
    ...
    <div style="text-align: center; margin-bottom: 20px;">
      ...
      <div style="font-size: 18px; font-weight: 700; color: var(--acc); margin-bottom: 4px;">SimpleLink Airdrop</div>
      <div style="font-size: 12px; color: var(--muted);">Secure Token Distribution</div>
    </div>
